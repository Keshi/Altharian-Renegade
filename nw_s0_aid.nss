...
// End of Spell Cast Hook
    ...
    if (nVesper == 1 || nVesper == 4)
      {
        ...
        if (nLevel > 10) nMod = ((nLevel - 10) / 30) + 1;
      }
    ...
    {
        nBonus = 8 * nMod;//Damage is at max
    }
    ...
    effect eSave = EffectSavingThrowIncrease(SAVING_THROW_ALL, nMod, SAVING_THROW_TYPE_FEAR);

    effect eHP = EffectTemporaryHitpoints(nBonus * 5);
