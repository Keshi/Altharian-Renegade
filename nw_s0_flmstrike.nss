...
// End of Spell Cast Hook
  ...
  oTarget = GetFirstObjectInShape(SHAPE_SPHERE, fSize, GetSpellTargetLocation(), FALSE, OBJECT_TYPE_CREATURE|OBJECT_TYPE_PLACEABLE|OBJECT_TYPE_DOOR);
  ...
  while ( GetIsObjectValid(oTarget) )
  {
       if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, OBJECT_SELF))
       {
           ...
           if (!MyResistSpell(OBJECT_SELF, oTarget, 0.6))
           {
                ...
                nDamage2 = GetReflexAdjustedDamage(nDamage/nFact, oTarget,(GetSpellSaveDC()+nMod), SAVING_THROW_TYPE_DIVINE);
                nDamage = GetReflexAdjustedDamage(nDamage/nFact, oTarget,(GetSpellSaveDC()+nMod), SAVING_THROW_TYPE_FIRE);
        ...
        oTarget = GetNextObjectInShape(SHAPE_SPHERE, fSize,GetSpellTargetLocation(), FALSE, OBJECT_TYPE_CREATURE|OBJECT_TYPE_PLACEABLE|OBJECT_TYPE_DOOR);
    }
}
