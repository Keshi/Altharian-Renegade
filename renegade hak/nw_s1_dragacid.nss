...
void main()
{
   ...
   //Use the HD of the creature to determine damage and save DC
    ...
    else if (nAge > 37) //Great Wyrm
    {
     ...
     if (GetTag(OBJECT_SELF)=="mc_swampdevil")
     {
        nDamage = 200;
        nDC = 40;
     }
   ...
   if (GetTag(OBJECT_SELF)=="pc_GreenDragon")
     {
        nDamage = 800;
        nDC = 80;
     }
...
// Check for Dragon armor/PC items
  ...
  //          nDamageDice = nAge;
   ...
   //     }
    ...
    AcidBreath = CreateBreath(OBJECT_SELF, TRUE, 80.0, DAMAGE_TYPE_ACID, nDamage, nDamageDice, ABILITY_CONSTITUTION, nDC);
