...
void SetDefaultFileEnds()
{
    ...
    SetPRCSwitch("PRC_FILE_END_cls_bfeat_fom", 9);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_bfeat_ml", 48);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_alag", 239);
    SetPRCSwitch("PRC_FILE_END_cls_feat_alien", 13);
    SetPRCSwitch("PRC_FILE_END_cls_feat_antipl", 785);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_archv", 2513);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_bard", 637);
    SetPRCSwitch("PRC_FILE_END_cls_feat_beguil", 692);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_cler", 826);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_divcha", 364);
    SetPRCSwitch("PRC_FILE_END_cls_feat_dnecro", 676);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_drowj", 65);
    SetPRCSwitch("PRC_FILE_END_cls_feat_drslyr", 220);
    SetPRCSwitch("PRC_FILE_END_cls_feat_druid", 814);
    SetPRCSwitch("PRC_FILE_END_cls_feat_duel", 88);
    SetPRCSwitch("PRC_FILE_END_cls_feat_duskbl", 619);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_favsol", 774);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_fistra", 367);
    SetPRCSwitch("PRC_FILE_END_cls_feat_fom", 67);
    SetPRCSwitch("PRC_FILE_END_cls_feat_foz", 235);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_kchal", 222);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_noble", 451);
    SetPRCSwitch("PRC_FILE_END_cls_feat_ocu", 786);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_psion", 936);
    SetPRCSwitch("PRC_FILE_END_cls_feat_psych", 212);
    SetPRCSwitch("PRC_FILE_END_cls_feat_psywar", 689);
    SetPRCSwitch("PRC_FILE_END_cls_feat_pyro", 293);
    SetPRCSwitch("PRC_FILE_END_cls_feat_ragem", 10);
    SetPRCSwitch("PRC_FILE_END_cls_feat_rang", 466);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_sbheir", 226);
    SetPRCSwitch("PRC_FILE_END_cls_feat_schord", 364);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_shaman", 1123);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_shugen", 587);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_sol", 372);
    SetPRCSwitch("PRC_FILE_END_cls_feat_sorc", 957);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_suel", 178);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_tempus", 88);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_urang", 595);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_feat_warmnd", 365);
    SetPRCSwitch("PRC_FILE_END_cls_feat_warpr", 84);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wilder", 897);
    SetPRCSwitch("PRC_FILE_END_cls_feat_witch", 760);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wiz", 503);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wm", 178);
    SetPRCSwitch("PRC_FILE_END_cls_feat_wrmage", 664);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_pres_dradis", 10);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_pres_fom", 6);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_pres_hath", 19);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_psicr_foz", 72);
    SetPRCSwitch("PRC_FILE_END_cls_psicr_psion", 170);
    SetPRCSwitch("PRC_FILE_END_cls_psicr_psywar", 76);
    SetPRCSwitch("PRC_FILE_END_cls_psicr_warmnd", 72);
    SetPRCSwitch("PRC_FILE_END_cls_psicr_wilder", 112);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spcr_dnecro", 132);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spell_favsol", 314);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spell_myst", 314);
    SetPRCSwitch("PRC_FILE_END_cls_spell_ocu", 828);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spkn_beguil", 39);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spkn_harper", 4);
    ...
    SetPRCSwitch("PRC_FILE_END_cls_spkn_schord", 9);
    SetPRCSwitch("PRC_FILE_END_cls_spkn_suel", 39);
    SetPRCSwitch("PRC_FILE_END_cls_spkn_witch", 39);
    ...
    SetPRCSwitch("PRC_FILE_END_prc_polymorph", 550);
    ...
    SetPRCSwitch("PRC_FILE_END_spells", 19999);
