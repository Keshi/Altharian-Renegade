/* Remove XP from player and give them the item, Warrior Demon Gauntlets
...
void main()
{
   ...
   if (GetXP (oPC)> 100000)
   {
       CreateItemOnObject("warriorsdream", oPC);
       SendMessageToAllDMs  (GetName(oPC)+": -100000 XP buying Warrior Demon Gauntlets");
