...
/*
    ...
    combat round
    ****  Modified to surrender and start default conversation
    **** if hit points drop below a set number
 */
//:://////////////////////////////////////////////////
...
const int SURRENDER_HITPOINTS = 50;
void main()
{
    object oDamager = GetLastDamager();
    if ( ( GetCurrentHitPoints() < SURRENDER_HITPOINTS ) )
    {
        SurrenderToEnemies();
        ActionStartConversation( oDamager );
    } else {
