/* Remove XP from player and give them the item, Arcane Demon Gauntlets
...
void main()
{
   ...
   if (GetXP (oPC)> 100000)
   {
       CreateItemOnObject("arcanecasters", oPC);
       SendMessageToAllDMs  (GetName(oPC)+": -100000 XP buying Arcane Demon Gauntlets");
