...
void main()
{
     if(!GetHasFeatEffect(FEAT_BARBARIAN_RAGE))
    {
        ...
        // Added plus one to the rage's duration to account for the round's actions you waste activating it.
        // :p
        ...
        DelayCommand(0.1, GiveExtraRageBonuses(nCon,StrBeforeBonuses , ConBeforeBonuses, nIncrease, nSave, OBJECT_SELF));
