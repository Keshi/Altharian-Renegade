...
// End of Spell Cast Hook
    ...
    int nMod = nCasterLvl/10;
    if (nCasterLvl > 20) nCasterLvl = 20 + (nCasterLvl - 20)/3;
    ...
    while(GetIsObjectValid(oTarget))
    {
        ...
        {
            int nDam = d10(nCasterLvl);
            effect eDam = EffectDamage(nDam,DAMAGE_TYPE_POSITIVE,DAMAGE_POWER_NORMAL);
               ...
               GetAssociate(ASSOCIATE_TYPE_ANIMALCOMPANION, oMaster) == oTarget )
            {
                ...
                nSpellDC = GetSpellSaveDC() + 6 + nMod;
