...
// First - we add the goodies from the combine to the base item
    ...
    if (nTally > nCount) SendMessageToPC(oPC,"You are attempting to add more than 6 properties to the item.  This can cause errors in transfer.  You should stop now, and limit your item to 8 properties.");
